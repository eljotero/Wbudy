...
// Constant related to LM75 device addresses.
...
void measureTemperature(void)
{
    ...
    if ((isNegative == (tU8)1) && ((readTemperature[1] & (tU8)0x80) == (tU8)1)){
    	...
    	appendHalf = 1;
    } else if ((isNegative == (tU8)0) && ((readTemperature[1] & (tU8)0x80) == (tU8)1)) {
